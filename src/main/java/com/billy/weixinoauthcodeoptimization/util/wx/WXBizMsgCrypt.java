...
public class WXBizMsgCrypt {
	...
	private static String encodingAesKey = ServerPropertiesUtil.getEncodingAesKey();
	public static String token = ServerPropertiesUtil.getToken();
	...
	public static String encryptMsg(String replyMsg){
		return encryptMsg(replyMsg, String.valueOf(System.currentTimeMillis()), UUID.randomUUID().toString());
	}
	...
	public static String decryptMsg(String msgSignature, String timeStamp, String nonce, String postData)
		...
		try {
			...
			// 解密
			result = decrypt(encrypt[1].toString());
		} catch(Exception e) {
			e.printStackTrace();
		}
		return result;
